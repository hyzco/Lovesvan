...
class Welcome extends Component {
  ...
  renderTermsService() {
    return (
      <Modal onRequestClose={()=>{}} animationType="slide" visible={this.state.showTerms} >
...
Welcome.defaultProps = {
  illustrations: [
    { id: 1, source: require('../../assets/images/illustration_1_logo.png')},
    { id: 2, source: require('../../assets/images/temeImages/illustration_1.png') },
    { id: 3, source: require('../../assets/images/temeImages/illustration_2.png') },
    { id: 4, source: require('../../assets/images/temeImages/illustration_3.png') },
  ],
};
